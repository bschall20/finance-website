    ...
    <div id="home">
      ...
      <div className="home2">
        <div className="home2Info">
          ...
          <p>
            Insert your expenses to get a look at how your financial future will
            impact you. Adjust the variables to fit your planning needs and feel
            more secure.
          </p>
        </div>
      </div>
          ...
          <Card border="success" className="mx-5" style={{ border: "none" }}>
            ...
            <Card.Body className="midCard">
              ...
              <Card.Text>
                ...
                needs. Apply any changes to your account finances, at any time.
              </Card.Text>
            </Card.Body>
          </Card>
