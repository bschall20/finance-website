...
function BarChart(props) {
  ...
  const dropdownSubmit = useCallback(
    (eventKey) => {
      let MortgageRentArr = [];
      let UtilitiesArr = [];
      let InsuranceArr = [];
  ...
  return (
    <div id="barChart">
      <div className="center barChartHeader">
        <div>
          <h2>
            Expense Bar Chart{" "}
            <CiCircleQuestion
        ...
        <div>
          <Dropdown
            onSelect={dropdownSubmit}
          >
            <Dropdown.Toggle
              variant="primary"
              id="dropdown-basic"
              className="barChartDropdown"
              style={{ backgroundColor: "#0D6EFD"}}
            >
              {dropdownTime || "Select an option"}
            </Dropdown.Toggle>
            <Dropdown.Menu>
              <Dropdown.Item eventKey="Day" className="barChartDropdown">Day</Dropdown.Item>
              <Dropdown.Item eventKey="Week" className="barChartDropdown">Week</Dropdown.Item>
              <Dropdown.Item eventKey="Month" className="barChartDropdown">Month</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </div>
      </div>
